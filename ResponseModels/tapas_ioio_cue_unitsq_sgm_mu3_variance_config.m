function c = tapas_ioio_cue_unitsq_sgm_mu3_variance_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_ioio_cue_unitsq_sgm_mu3';
...
% Model filehandle
c.obs_fun = @tapas_ioio_unitsq_sgm_mu3;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @tapas_ioio_unitsq_sgm_mu3_transp;
