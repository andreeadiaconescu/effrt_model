function [logp, yhat, res] = ioio_constant_voltemp_exp_withdecisionnoise(r, infStates, ptrans)
...
yhat(not(ismember(1:length(logp),r.irr))) = b;
res(not(ismember(1:length(logp),r.irr))) = (y-b)./sqrt(b.*(1-b));
