function c = hgf_binary3l_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% uncertainty.
%
% THIS MODEL IS THE OLD VERSION OF hgf_binary. IT IS INCLUDED IN THE TOOLBOX SOLELY FOR BACKWARDS
% COMPATIBILITY.
%
...
%settings discussed with Andreea 2015
%%model: 'hgf_binary3l'
            %  kaub: 1
           %   thub: 1
          % mu2_0mu: 0
...
c.mu3_0mu = 1;
c.mu3_0sa = 1; % 1Free this for voltemp models %0
...
c.logitkamu = 0; %-1 %-0.5 for lowered lower bound of th
c.logitkasa = 1;
...
% Theta
c.logitthmu = 0; %-1; %if lower the upper bound set to -1 if not use 0%0
c.logitthsa = 1;

% Gather prior settings in vectorsvar
c.priormus = [
    c.mu2_0mu,...
    c.logsa2_0mu,...
    c.mu3_0mu,...
...
c.prc_fun = @hgf_binary3l;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_binary3l_transp;
