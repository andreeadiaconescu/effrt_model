function c = hgf_binary_ar1_allfree_raisedm3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
c.logitphimu = [NaN, -Inf, tapas_logit(0.1,1)]; %tapas_logit(0.1,1)];
...
% Undefined (therefore NaN) at the first level.
c.mmu = [NaN, c.mu_0mu(2), c.mu_0mu(3)*3];
c.msa = [NaN, 0,           1];
...
c.thub = 0.55; % set to zero previously
...
c.prc_fun = @hgf_binary_ar1_allfree_raisedm3;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @hgf_binary_ar1_allfree_raisedm3_transp;
