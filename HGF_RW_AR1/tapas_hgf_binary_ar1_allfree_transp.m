function [pvec, pstruct] = tapas_hgf_binary_ar1_allfree_transp(r, ptrans)
% --------------------------------------------------------------------------------------------------
